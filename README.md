...
Implementação de uma árvore binária em Java, desenvolvida.

A atividade consistiu em criar uma árvore binária fixa e
implementar diferentes tipos de caminhamento, além de
